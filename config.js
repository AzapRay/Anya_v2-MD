...
module.exports = {
     ...
     */
    ownername: process.env.Owner_Name || "Zap_32",
    ownernumber: process.env.Owner_Number || "+237651878539",
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://Zap:<db_password>@cluster0.ki4tl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
